...
const shadowRules = require('./cgi/shadowRules');
const setWhiteList = require('./cgi/setWhiteList');
const getWhiteList = require('./cgi/getWhiteList');
...
module.exports = (router) => {
  router.get('/cgi-bin/white-list', getWhiteList);
  ...
  router.all('/whistle.nohost/**', async (ctx) => {
    await passThrough(ctx);
  });
  ...
  router.get('/shadow-rules', shadowRules);
