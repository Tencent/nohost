...
const setGlobalRules = require('./cgi/admin/setGlobalRules');
...
const changeAccountPassword = require('./cgi/account/changePassword');
...
module.exports = (router) => {
  ...
  router.get('/cgi-bin/rules', (ctx) => {
    ctx.body = ctx.accountMgr.parasedEntryRules;
  });
  ...
  router.post('/cgi-bin/admin/set-global-rules', setGlobalRules);
  ...
  router.post('/cgi-bin/account/change-password', changeAccountPassword);
