...
class AccountMgr {
  ...
  parseRules() {
    ...
    const globalRules = getStringProperty('globalRules');
    ...
    const {
      ...
      priPatterns,
      pubPatterns,
    } = parseEntryRules(this.entryRules);
    this.parasedEntryRules = `${entryRules}\n${globalRules}`;
    ...
    this.pluginRules = getStringProperty('pluginRules');
    this.parsedMap = {};
    accoutMap = {};
  ...
  setGlobalRules(str) {
    ...
    storage.setProperty('globalRules', str);
    this.parseRules();
  }
  ...
  setPluginRules(str) {
    ...
    storage.setProperty('pluginRules', str);
    this.pluginRules = str;
  }
